    ...
    return (
      <main className="pt-24 section-padding">
        <div className="container-width mx-auto text-center">
          <h1 className="text-3xl font-bold text-neutral-50 mb-4">Service not found</h1>
      ...
      <section className="section-padding">
        <div className="container-width mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <Link to="/services" className="inline-flex items-center gap-2 text-sm text-neutral-400 hover:text-accent-500 transition-colors mb-8">
          ...
          <motion.div
            ...
            className="mb-20"
          >
            <h2 className="text-2xl font-bold text-neutral-50 mb-8">What&apos;s Included</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {service.features.map((f, i) => (
                <motion.div
                  ...
                  className="flex items-center gap-3 p-4 rounded-lg border border-brand-700 bg-brand-800/20"
                >
          ...
          <div className="mb-20">
            <h2 className="text-2xl font-bold text-neutral-50 mb-8 text-center">Our Process</h2>
            <div className="space-y-6">
              {processSteps.map((step, i) => (
                <motion.div
                  ...
                  className="flex gap-6 p-6 rounded-xl border border-brand-700 bg-brand-800/20"
                >
                  <span className="text-3xl font-bold font-mono text-accent-500/30 shrink-0">{step.step}</span>
                  <div>
                    <h3 className="text-lg font-semibold text-neutral-50 mb-1">{step.title}</h3>
          ...
          >
            <h2 className="text-2xl font-bold text-neutral-50 mb-4">Ready to get started?</h2>
            <p className="text-neutral-300 mb-8">Let&apos;s discuss how {service.title} can help your business grow.</p>
