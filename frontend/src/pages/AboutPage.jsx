        ...
        <div className="container-width mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 rounded-xl border border-brand-700 bg-brand-800/20"
            >
              <Target className="w-8 h-8 text-accent-500 mb-4" />
              <h3 className="text-xl font-semibold text-neutral-50 mb-3">Our Mission</h3>
            ...
            <motion.div
              ...
              className="p-8 rounded-xl border border-brand-700 bg-brand-800/20"
            >
              <Eye className="w-8 h-8 text-accent-500 mb-4" />
              <h3 className="text-xl font-semibold text-neutral-50 mb-3">Our Vision</h3>
              <p className="text-neutral-300 leading-relaxed">
          ...
          <div className="mb-20">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-3xl font-bold text-neutral-50 text-center mb-12"
            >
              Our Journey
            </motion.h2>
            <div className="relative">
              <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px bg-brand-700 -translate-x-1/2" />
              <div className="space-y-8">
                {milestones.map((m, i) => (
                  ...
                  >
                    ...
                    <div className="absolute left-4 md:left-1/2 w-3 h-3 rounded-full bg-accent-500 border-4 border-brand-900 -translate-x-1/2 z-10" />
                    <div className="ml-12 md:ml-0 md:w-1/2 p-5 rounded-xl border border-brand-700 bg-brand-800/30">
                      <div className="flex items-center gap-2 mb-2">
                        <Calendar className="w-4 h-4 text-accent-500" />
                        <span className="text-accent-500 font-mono text-sm">{m.year}</span>
                      </div>
                      <h4 className="text-lg font-semibold text-neutral-50 mb-1">{m.title}</h4>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {team.map((member, i) => (
                <motion.div
                  ...
                  className="p-6 rounded-xl border border-brand-700 bg-brand-800/20 text-center hover:border-accent-500/30 transition-colors"
                >
                  <div className="w-16 h-16 rounded-full bg-accent-500/10 border border-accent-500/30 flex items-center justify-center mx-auto mb-4 text-accent-500 font-semibold">
                    {member.initials}
                  </div>
                  <h4 className="font-semibold text-neutral-50">{member.name}</h4>
