        ...
        <div className="container-width mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-sm text-white/70 leading-relaxed mb-6">
                Empowering businesses across Pakistan with end-to-end IT solutions.
                From infrastructure to innovation, we engineer technology that scales.
              </p>
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="p-2 rounded-lg border border-white/10 text-white/50 hover:text-accent hover:border-accent/30 transition-colors"
                  aria-label="LinkedIn"
                >
          ...
          <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-white/40">
              &copy; 2025 Code Voyagers. All rights reserved.
            </p>
