  ...
  return (
    <section className="section-padding bg-base">
      <div className="container-width mx-auto">
        <div className="relative rounded-xl border border-border overflow-hidden bg-surface shadow-card">
          ...
          <div className="relative px-8 py-16 sm:px-12 sm:py-20 text-center">
            ...
            <motion.p
              ...
              className="text-body-lg text-text-body max-w-xl mx-auto mb-8"
            >
