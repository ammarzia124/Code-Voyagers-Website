        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <motion.h2
              ...
              className="text-display-md font-display font-bold text-text-primary mb-6"
            >
          ...
          <div className="space-y-6">
            {values.map((value, index) => (
              <motion.div
                ...
                className="flex items-start gap-4 p-5 rounded-lg border border-border bg-surface hover:shadow-card transition-shadow"
              >
                <div className="p-2.5 rounded-lg bg-brand-light shrink-0">
                  <value.icon className="w-5 h-5 text-brand" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-text-primary mb-1 font-display">{value.title}</h3>
